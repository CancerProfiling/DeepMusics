...
from train_without import trainDeepMusicsNet_without
...
x_train, ytime_train, yevent_train = load_data_without("~/scna_rna.train.csv", dtype)
x_valid, ytime_valid, yevent_valid= load_data_without("~/scna_rna.test.csv", dtype)
x_test, ytime_test, yevent_test= load_data_without("~/scna_rna.validation.csv", dtype)
opt_l2_loss = 0
opt_lr_loss = 0
