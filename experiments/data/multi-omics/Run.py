...
x_train, ytime_train, yevent_train, age_train = load_data("~/scna_rna.train.csv", dtype)
x_valid, ytime_valid, yevent_valid, age_valid = load_data("~/scna_rna.test.csv", dtype)
x_test, ytime_test, yevent_test, age_test = load_data("~/scna_rna.validation.csv", dtype)
